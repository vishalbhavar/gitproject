...
$dbname="ropvatika";
 ...
 $sql="select* from plant where category='flower'";
 ...
 if($result>0)
 {
  while($row=mysqli_fetch_assoc($data))
  {
	  ...
	  echo"<tr>";
	  echo"<td>";
	  echo "<h5>Category:</h5>".$category=$row["category"]."</br>"."</br>";
	  echo "Name :&nbsp;&nbsp; "; $name=$row["name"];
	  echo "<input type='text' value='$name' name='product' readonly /><br><br>";
      echo"Price :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";$price=$row["price"];
	  echo "<input type='text' value='$price' name='price' readonly />";
	  echo "</br></br>";
	  echo"Quantity:&nbsp;";
	  echo "<input type='number' name='quant' placeholder = 'Select Quantity'/>";
	  echo"</br></br><input type='Submit' value='BuyNow' />";
	  echo "</form>";
